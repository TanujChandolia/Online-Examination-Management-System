...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			<h2 class="text-center">Manage the data of all the teachers</h2>
			<br>
			<a href="add_teacher.php" class="btn btn-success btn-lg btn-block"> Add a new Teacher</a>
		</div>
		...
		<?php
			...
			$query = "SELECT * FROM teacher_acc ORDER BY name asc";
