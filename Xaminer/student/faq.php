...
<body>
	...
	<div class="container">
		<div class="jumbotron text-center">
		  ...
		  <p class="lead">This page is dedicated to clear all the common doubts and situations students face. In case your doubt is not cleared, please send your queries to the admin.</p>
		  <hr class="my-4">
		  <p>Use this to send a query.</p>
		  <a class="btn btn-info btn-lg" href="student_query.php" role="button">Ask a Query</a>
		</div>

		<div class="content">
			<h3 >1. How does one give the exam?</h3>
